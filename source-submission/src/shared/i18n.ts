...
const translations: Record<Language, Translations> = {
  ...
  de: {
    ...
    ocPanel: {
      ...
      activateCta: 'Aktivieren',
      activateDescription: 'Cashback auf %1$s',
      activateNow: 'Cashback jetzt aktivieren',
      activateTitle: 'Erhalte jetzt %1$s zurück',
  ...
  fr: {
    ...
    ocPanel: {
      ...
      activateCta: 'Activer',
      activateDescription: 'Cashback sur %1$s',
      activateNow: 'Activer le cashback maintenant',
      activateTitle: 'Obtenez %1$s maintenant',
  ...
  it: {
    ...
    ocPanel: {
      ...
      activateCta: 'Attiva',
      activateDescription: 'Cashback su %1$s',
      activateNow: 'Attiva cashback ora',
      activateTitle: 'Ottieni ora %1$s indietro',
  ...
  es: {
    ...
    ocPanel: {
      ...
      activateCta: 'Activar',
      activateDescription: 'Cashback en {host}',
      activateNow: 'Activar cashback ahora',
      activateTitle: 'Obtén %1$s ahora',
